...
create view analysis.orderstatuslog as select * from production.orderstatuslog osl;
create view analysis.products as select * from production.products p;
create view analysis.users as select * from production.users u;
